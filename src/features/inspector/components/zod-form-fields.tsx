          ...
          <div key={field.name}>
            ...
            {field.type === 'text' && (
              <input
                ...
                {...register(field.name)}
                className="h-8 w-full rounded-md border bg-background px-2 text-sm focus:outline-none focus:ring-1 focus:ring-ring disabled:opacity-50"
              />
            )}
            ...
            {field.type === 'textarea' && (
              <textarea
                ...
                aria-describedby={error ? `${field.name}-error` : field.description ? `${field.name}-desc` : undefined}
                {...register(field.name)}
                className="w-full rounded-md border bg-background px-2 py-1 text-sm resize-y focus:outline-none focus:ring-1 focus:ring-ring disabled:opacity-50"
              />
            )}
