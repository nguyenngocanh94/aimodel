...
export const WorkflowNodeCard = memo(function WorkflowNodeCard({
  ...
  return (
    <div
      ...
      className={cn(
        // Base
        'group relative w-[260px] rounded-lg border border-l-[3px] bg-card text-card-foreground shadow-[0_2px_8px_rgba(0,0,0,0.3)]',
        ...
        // Default border
        'border-border',
        // Hover (lift + shadow only — border stays for accent)
        ...
        // Running — amber left rule
        isRunning && 'border-l-signal',
      )}
    ...
    >
      ...
      <div className="flex items-start gap-2 px-3 pb-2 pt-3">
        ...
        {/* Quick menu button */}
        <button
          className="nodrag flex h-8 w-8 items-center justify-center rounded-sm p-1 text-muted-foreground opacity-0 group-hover:opacity-100 hover:bg-accent hover:text-accent-foreground focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring transition-hover"
