...
const COMPATIBILITY_MATRIX: Readonly<Record<DataType, Readonly<Record<DataType, CompatibilityEntry>>>> = {
  ...
  text: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Text cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Text cannot be converted to video URL list' },
  ...
  prompt: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Prompt cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Prompt cannot be converted to video URL list' },
  ...
  script: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Script cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Script cannot be converted to video URL list' },
  ...
  scene: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Scene cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Scene cannot be converted to video URL list' },
  ...
  imageFrame: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image frame cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image frame cannot be converted to video URL list' },
  ...
  imageAsset: {
    ...
    audioAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image cannot be converted to audio' },
    subtitleAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image cannot be converted to subtitle' },
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image asset cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image asset cannot be converted to video URL list' },
  ...
  audioPlan: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Audio plan cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Audio plan cannot be converted to video URL list' },
  ...
  audioAsset: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Audio asset cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Audio asset cannot be converted to video URL list' },
  ...
  subtitleAsset: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Subtitle cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Subtitle cannot be converted to video URL list' },
  ...
  videoAsset: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video asset cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video asset cannot be converted to video URL list' },
  ...
  reviewDecision: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Review decision cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Review decision cannot be converted to video URL list' },
  ...
  json: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'JSON cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'JSON cannot be converted to video URL list' },
  ...
  textList: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Text list cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Text list cannot be converted to video URL list' },
  ...
  promptList: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Prompt list cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Prompt list cannot be converted to video URL list' },
  ...
  sceneList: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Scene list cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Scene list cannot be converted to video URL list' },
  ...
  imageFrameList: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image frame list cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image frame list cannot be converted to video URL list' },
  ...
  imageAssetList: {
    ...
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image asset list cannot be converted to video URL' },
    videoUrlList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Image asset list cannot be converted to video URL list' },
  ...
  // === VIDEO URL TYPES ===
  videoUrl: {
    text: { compatible: true, coercionApplied: true, severity: 'warning', reason: 'Video URL extracted as text' },
    textList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to text list' },
    prompt: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL is not a prompt' },
    promptList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to prompt list' },
    script: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to script' },
    scene: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to scene' },
    sceneList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to scene list' },
    imageFrame: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to image frame' },
    imageFrameList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to image frame list' },
    imageAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to image asset' },
    imageAssetList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to image asset list' },
    audioPlan: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to audio plan' },
    audioAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to audio asset' },
    subtitleAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to subtitle' },
    videoUrl: { compatible: true, coercionApplied: false, severity: 'none', reason: 'Exact type match' },
    videoUrlList: { compatible: true, coercionApplied: true, severity: 'warning', reason: 'Single video URL wrapped in list' },
    videoAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL is not a video asset (needs generation)' },
    reviewDecision: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL cannot be converted to review decision' },
    json: { compatible: true, coercionApplied: true, severity: 'warning', reason: 'Video URL wrapped as JSON string' },
  },
  videoUrlList: {
    text: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to text' },
    textList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to text list' },
    prompt: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to prompt' },
    promptList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to prompt list' },
    script: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to script' },
    scene: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to scene' },
    sceneList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to scene list' },
    imageFrame: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to image frame' },
    imageFrameList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to image frame list' },
    imageAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to image asset' },
    imageAssetList: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to image asset list' },
    audioPlan: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to audio plan' },
    audioAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to audio asset' },
    subtitleAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to subtitle' },
    videoUrl: { compatible: false, coercionApplied: false, severity: 'error', reason: 'List cannot be destructively coerced to single item' },
    videoUrlList: { compatible: true, coercionApplied: false, severity: 'none', reason: 'Exact type match' },
    videoAsset: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list is not a video asset (needs generation)' },
    reviewDecision: { compatible: false, coercionApplied: false, severity: 'error', reason: 'Video URL list cannot be converted to review decision' },
    json: { compatible: true, coercionApplied: true, severity: 'warning', reason: 'Video URL list wrapped as JSON array' },
  },
};
...
export function getListType(scalarType: DataType): DataType | undefined {
  ...
  const validTypes: DataType[] = [
    ...
    'audioPlan', 'audioAsset', 'subtitleAsset', 'videoUrl', 'videoUrlList',
    'videoAsset', 'reviewDecision', 'json'
  ];
