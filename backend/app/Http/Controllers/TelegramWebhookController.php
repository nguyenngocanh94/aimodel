...
{
    /** @var \Closure(string $chatId, string $botToken): TelegramAgent */
    ...
    public function __construct(
        ...
        $this->agentFactory = $agentFactory
            ?? fn(string $chatId, string $botToken): TelegramAgent
                => new TelegramAgent($chatId, $botToken, $this->slashRouter);
    }
    ...
    public function handle(Request $request, string $botToken): JsonResponse
    {
        ...
        $agent  = ($this->agentFactory)($chatId, $botToken);
