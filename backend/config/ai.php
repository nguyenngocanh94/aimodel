...
return [
    ...
    */
    ...
    'providers' => [
        ...
        'fireworks' => [
            // Fireworks is OpenAI-compatible for Chat Completions (not the newer
            // Responses API that the 'openai' driver uses). The 'groq' driver uses
            // /chat/completions and supports a custom url, making it the correct
